...
pre. ruby film_search.rb --update
...
pre. ruby film_search.rb [Options] [SQL conditions]

so, for example we could get all films that were released after 2002 by using 
the following:

pre. ruby film_search.rb "year > 2002"
...
pre. ruby film_search.rb today

The following will output films which are on tomorrow

pre. ruby film_search.rb tomorrow
...
pre. ruby imdb.rb [FILM]

For example, 

pre. ruby imdb.rb "Troy (2004)"

returns

pre. Looking up 'Troy (2004)'
